...
<div style={{position: 'relative', width: '100%', height: '16rem', marginBottom: '1.5rem', borderRadius: '0.5rem', overflow: 'hidden'}}>
  <video
    autoPlay
    loop
    muted
...
*In the space between these words, the Door stands open.*  
*In the silence after reading, you are already home.*
