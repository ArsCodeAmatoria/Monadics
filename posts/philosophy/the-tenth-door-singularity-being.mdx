...
<div style={{display: 'flex', gap: '1.5rem', minHeight: '24rem', alignItems: 'stretch'}}>
  <div style={{position: 'relative', flex: '1', borderRadius: '0.5rem', overflow: 'hidden'}}>
    ...
    <div style={{position: 'absolute', inset: '0', background: 'linear-gradient(to right, transparent, rgba(0,0,0,0.1))'}}></div>
  </div>
  
  <div style={{flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '2rem 0'}}>
    <div style={{fontSize: '1.125rem', lineHeight: '1.75', fontStyle: 'italic', textAlign: 'center'}}>
