...
<div style={{display: 'flex', gap: '2rem', minHeight: '24rem', alignItems: 'stretch'}}>
  <div style={{flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingRight: '1rem'}}>
    <div style={{textAlign: 'left', fontFamily: 'serif'}}>
      <h3 style={{fontSize: '1.5rem', fontWeight: '300', letterSpacing: '0.05em', marginBottom: '2rem', color: 'inherit', fontStyle: 'normal'}}>
        THE THRESHOLD
      </h3>
      
      <div style={{fontSize: '1.125rem', lineHeight: '2', fontStyle: 'italic', color: 'inherit', paddingLeft: '1rem', borderLeft: '3px solid currentColor', marginLeft: '0.5rem'}}>
        <p style={{marginBottom: '2rem', fontWeight: '300'}}>
          <em>In the space between these words,<br/>the Door stands open.</em>
        </p>
        
        <p style={{fontWeight: '300'}}>
          <em>In the silence after reading,<br/>you are already home.</em>
        </p>
      </div>
    </div>
  </div>
