...
<Table>
  <TableHeader>
    <TableRow>
      <TableHead>Lisp Concept</TableHead>
      <TableHead>DMN Function</TableHead>
    </TableRow>
  </TableHeader>
  <TableBody>
    <TableRow>
      <TableCell>Recursive functions</TableCell>
      <TableCell>Recursive thought loops</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Self-evaluating expressions</TableCell>
      <TableCell>Metacognitive self-monitoring</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Symbolic abstraction</TableCell>
      <TableCell>Conceptual reasoning about the self</TableCell>
    </TableRow>
  </TableBody>
</Table>
