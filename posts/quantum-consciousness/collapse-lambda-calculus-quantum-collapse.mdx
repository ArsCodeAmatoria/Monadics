...
thumbnail: "F799Q7tXUAAz3qW.jpeg"
---
...
<Table>
  ...
  <TableBody>
    <TableRow>
      <TableCell className="font-medium">Collapse Derivative</TableCell>
      <TableCell>$\delta_C f(x) = f(\text{collapse}(x)) - f(x)$</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Integral</TableCell>
      <TableCell>$\int_C f \, dP = \sum f(\omega) P(\omega)$</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Algebra</TableCell>
      <TableCell>$C_i^2 = C_i, C_i^\dagger = C_i$, orthogonal idempotents</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Chains</TableCell>
      <TableCell>Probabilistic sequences $\psi_i \to \psi_{i+1}$</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Category</TableCell>
      <TableCell>States + collapse morphisms, with monoidal structure</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Entropy</TableCell>
      <TableCell>$S = -\sum P(\omega) \log P(\omega)$</TableCell>
    </TableRow>
    <TableRow>
      <TableCell className="font-medium">Collapse Time</TableCell>
      <TableCell>$\tau = \frac{\hbar}{E_G}$ or $\frac{\hbar}{\Delta I}$</TableCell>
    </TableRow>
  </TableBody>
</Table>
